...
<div class="dynamic-main">
        ...
        <div class="content-cont">
            <div class="stats">
                ...
                <button class="info-change" onclick="location.href='./crud/update-user.php?updateid=<?php echo $row['usersID']?>'">Update Info</button>
            </div>
            ...
            <div>
                ...
                <button class="image-up">Upload Image</button>
            </div>
        </div> 
    </div>
</body>
